...
class Metabox_Url_Translate_Weglot implements Hooks_Interface_Weglot {
	...
	public function weglot_url_translate_box( $post ) {
		...
		echo sprintf( esc_html__( 'The translation URL feature is now available in your Weglot account (Requires Pro plan minimum) : %1$sTranslate URL slugs%2$s.', 'weglot' ), '<a target="_blank" href="' . $project_slug_url . '">', '</a>' );
	}
}
