...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td class="forminp forminp-text">
			<a class="btn btn-soft" href="<?php echo $project_url_exclusions; ?>" target="_blank"><span
	...
	<tr valign="top">
		...
		<td class="forminp forminp-text">
			<a class="btn btn-soft" href="<?php echo $project_blocks_exclusions; ?>" target="_blank"><span
	...
	<tr valign="top">
		...
		<td class="forminp forminp-text">
			...
			<?php if ( $this->options['page_views_enabled'] ) : ?>
				<p class="description"><a target="_blank" href="<?php echo $project_pageviews; ?>" title="Page views tracking is activated">Page views tracking</a> is <b>activated</b></p>
			<?php else : ?>
				<p class="description"><a target="_blank" href="<?php echo $project_pageviews; ?>" title="Page views tracking is deactivated">Page views tracking</a> is <b>deactivated</b></p>
			<?php endif; ?>
